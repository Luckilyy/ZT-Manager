...
<html>
    ...
    foreach ($ret as $key => $value) {
        ...
        $ret[$i]->first_child()->first_child()->attr['href'] = str_replace("https://ww1.zone-telechargement.ws", "SeriesDetails.php?series=https://ww1.zone-telechargement.ws", $ret[$i]->first_child()->first_child()->attr['href']);
        $ret[$i]->last_child()->first_child()->first_child()->first_child()->attr['href'] = str_replace("https://ww1.zone-telechargement.ws", "SeriesDetails.php?series=https://ww1.zone-telechargement.ws", $ret[$i]->last_child()->first_child()->first_child()->first_child()->attr['href']);
        echo $ret[$i];
        echo"</div>";
    }
    ?>
